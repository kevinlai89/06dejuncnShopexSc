...
//define('DB_NAME', 'ec20160519Jing3data');    # 数据库名
define('DB_NAME', '06dejuncnShopexScData');    # 数据库名
...
define('STORE_KEY', 'a24f598509cbf1f18a9195a9e011c98c'); #密钥
...
define('CUSTOM_CORE_DIR', BASE_DIR.'/core_qf');

define('RECV_GREQ_EMAIL', 'zdt_kevin@qq.com');