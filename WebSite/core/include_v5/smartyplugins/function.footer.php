...
function tpl_function_footer($params, &$smarty)
{
    ...
    if($system->getConf('site.shopex_certify')==0){
        ...
        $PoweredStr='<div style="font-family:Verdana;line-height:20px!important;height:auto!important;font-size:11px!important;text-align:center;overflow:none!important;text-indent:0!important;display:none">';
