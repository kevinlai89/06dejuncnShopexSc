...
var Focus_tuan = new Class({    
    ...
    init: function() {
        this.fireEvent("onRender", [this.index, this.items.length]);
    ...
    render: function() {
        ...
        this.step = ops.step;
        this.items = hd.getElements('.itemsWrap');
        ...
        this.leftBtn = document.id(ops.button.left).setStyle('opacity', 1);
        this.rightBtn = document.id(ops.button.right).setStyle('opacity', 1);
        ...
        hd.set('tween', {
            ...
            onComplete: function() {
                ...
                this.lock = false;
                this.fireEvent("onShow", [items[this.index], this.index, items.length]);
            }.bind(this)
        });
    ...
    leave: function() {
        this.timer = setTimeout(function() {
            this.leftBtn.get('tween').start('opacity', 1, 1);
            this.rightBtn.get('tween').start('opacity', 1, 1);
